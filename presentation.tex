...
\begin{frame}{Minimizing Duration = Optimal Shaping}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{images/shaping-phase.png}
    \end{figure}
    Controlling the phase \redify{in the frequency domain} impacts the pulse's duration \redify{in the temporal domain}.
        \begin{itemize}
            \item \circled{1} \highlight{In control} \notebox{Stretching the pulse into fundamental frequencies} 
            \item \circled{2} \highlights{Out of control} Amplifying the different frequencies (\redify{non-linear})
            \item \circled{3} \highlights{Out of control} Recompressing in time, aligning frequencies yielding \highlight{constructive interferences}
        \end{itemize}
\end{frame}
%---------------------------------------
...
\begin{frame}[fragile]{Deep RL to the rescue (3/3)}
    ...
    \begin{column}{0.5\textwidth}
        \centering
        \begin{figure}
            \animategraphics[width=\linewidth,autoplay,loop]{24}{images/erratic-control-frames/}{0}{149}
        \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
        \begin{figure}
...
\begin{frame}[fragile]{Deep RL for pulse shaping}
    \begin{figure}
        \animategraphics[width=0.8\linewidth,autoplay,loop]{24}{images/environment-rendering-frames/}{0}{143}
    \end{figure}
