...
\institute[]{
    \inst{1} \adjustbox{valign=c}{\includegraphics[height=0.5cm]{images/ens-ps.png}} \highlight{ENS} Paris-Saclay \quad
    \inst{2} \adjustbox{valign=c}{\includegraphics[height=0.5cm]{images/hf.png}} \highlight{Hugging Face} \quad
    \inst{3} \adjustbox{valign=c}{\includegraphics[height=0.5cm]{images/elilogo.png}} \highlight{ELI} Beamlines \and
    \inst{4} \adjustbox{valign=c}{\includegraphics[height=0.5cm]{images/Wurzuburg.png}} \highlight{JMU} Würzburg \quad
    \inst{5} \adjustbox{valign=c}{\includegraphics[height=0.5cm]{images/Darmstandt.png}} \highlight{TU} Darmstadt
}
...
\begin{frame}[fragile]{Optimal Shaping = Minimizing Duration}
    \begin{figure}
...
\end{frame}
%---------------------------------------
\begin{frame}{Optimal Shaping = Minimizing Duration}
    \begin{figure}
...
\begin{frame}[fragile]{Deep RL for Pulse Shaping}
    ...
    \begin{figure}
        \animategraphics[width=0.9\linewidth,autoplay,loop]{24}{images/environment-rendering-frames/}{0}{143}
    \end{figure}
\end{frame}
%---------------------------------------
\begin{frame}{Conclusions}
We present a new method for shaping laser pulses using Deep RL.
\uncover<+->{
\begin{itemize}[<+->]
   ...
   \item We train in simulation, ensuring (safe) exploration by leveraging results on cross-domain transferability.
\end{itemize}
}
\vspace{1em}
\uncover<+->{
